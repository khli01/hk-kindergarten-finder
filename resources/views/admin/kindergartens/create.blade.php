...
@section('title', 'Add Kindergarten')
@section('page-title', 'Add New Kindergarten')

@section('content')
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.kindergartens.store') }}" method="POST">
            @csrf
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <select name="school_type" class="form-select">
                        ...
                        <option value="non_profit" {{ old('school_type') == 'non_profit' ? 'selected' : '' }}>Non-Profit</option>
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    ...
                    <input type="text" name="address_zh_tw" class="form-control @error('address_zh_tw') is-invalid @enderror" 
                           value="{{ old('address_zh_tw') }}" required>
                    @error('address_zh_tw')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-4">
                    <label class="form-label">Address (Simplified Chinese) *</label>
                    <input type="text" name="address_zh_cn" class="form-control @error('address_zh_cn') is-invalid @enderror" 
                           value="{{ old('address_zh_cn') }}" required>
                    @error('address_zh_cn')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-4">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <div class="d-flex gap-4">
                        <div class="form-check">
                            <input type="checkbox" name="has_pn_class" value="1" class="form-check-input" {{ old('has_pn_class') ? 'checked' : '' }}>
                            <label class="form-check-label">PN Class</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" name="has_k1" value="1" class="form-check-input" checked {{ old('has_k1', true) ? 'checked' : '' }}>
                            <label class="form-check-label">K1</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" name="has_k2" value="1" class="form-check-input" checked {{ old('has_k2', true) ? 'checked' : '' }}>
                            <label class="form-check-label">K2</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" name="has_k3" value="1" class="form-check-input" checked {{ old('has_k3', true) ? 'checked' : '' }}>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="ranking_score" class="form-control" value="{{ old('ranking_score', 0) }}" min="0" max="100">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Primary Success Rate (%)</label>
                    <input type="number" name="primary_success_rate" class="form-control" value="{{ old('primary_success_rate') }}" min="0" max="100" step="0.1">
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-md-3">
                    ...
                    <input type="number" name="monthly_fee_min" class="form-control" value="{{ old('monthly_fee_min') }}" min="0">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Monthly Fee (Max)</label>
                    <input type="number" name="monthly_fee_max" class="form-control" value="{{ old('monthly_fee_max') }}" min="0">
                </div>
                <div class="col-md-6">
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    ...
                    <textarea name="description_zh_tw" class="form-control" rows="4">{{ old('description_zh_tw') }}</textarea>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Description (Simplified Chinese)</label>
                    <textarea name="description_zh_cn" class="form-control" rows="4">{{ old('description_zh_cn') }}</textarea>
                </div>
                <div class="col-md-4">
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-check-lg me-1"></i> Save Kindergarten
                </button>
                <a href="{{ route('admin.kindergartens.index') }}" class="btn btn-outline-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
